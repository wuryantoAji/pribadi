...
public class PilotController {
	...
	public String view(@RequestParam("licenseNumber") String licenseNumber, Model model) {
		...
		if(archive == (null)) {
			...
			model.addAttribute("pilot", empty);
		}else {
			String nomor =archive.getLicenseNumber();
			String nama =archive.getName();
			int hour =archive.getFlyHour();
			model.addAttribute("LicenseNumber", nomor);
			model.addAttribute("Name", nama);
			model.addAttribute("FlyHour", hour);
